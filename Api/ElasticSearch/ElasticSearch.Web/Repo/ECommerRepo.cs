...
{
    public class ECommerRepo
    {
        private readonly ElasticsearchClient _elasticSearchClient;

        public ECommerRepo(ElasticsearchClient elasticSearchClient)
        {
        ...
        private async Task<(List<ECommerce> list, long count)> CalculateResultSet(int page, int pageSize, List<Action<QueryDescriptor<ECommerce>>> listQuery)
        {
            ...
            var result = await _elasticSearchClient.SearchAsync<ECommerce>(s => s.Indices(indexName)
